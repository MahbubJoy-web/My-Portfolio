...
const Contact = () => {
  ...
  return (
    <div className="pt-[100px] pb-[40px]" style={{ backgroundImage: `url(${BannerBG})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
      <div className="container">
        <div className="flex flex-col items-center justify-center relative">
          <div className="text-[48px] font-inter font-bold pb-[60px]">
          ...
          <form ref={form} onSubmit={sendEmail}>
            <div className="font-inter font-normal text-[20px] text-[#BEC1DD] flex flex-col gap-5">
              <input
                ...
                className="bg-transparent outline-none border border-[#7681c6] p-[3px] pl-3 w-[500px] rounded-[5px] text-[#BEC1DD]"
              ...
              <textarea
                name="message"
                className="bg-transparent outline-none border border-[#7681c6] p-[3px] pl-3 w-[500px] h-[250px] rounded-[5px] text-[#BEC1DD] overflow-y-scroll"
                placeholder="Message....."
              />
              <div className="w-full flex justify-center mt-5">
                <button
                  type="submit"
                  className="w-[200px] py-[12px] px-[20px] bg-gradient-to-r from-[#161A31] to-[#06091F] rounded-[14px] border-[3px] border-[#20243dda] text-center text-[20px] font-inter font-medium"
                >
                  Send
                </button>
              </div>
           ...
           <div className="w-full flex justify-center items-center mt-[90px]">
            ...
            <div className=" flex flex-col absolute bottom-0 right-[200px] gap-5">

        ...
        <div className=".comtainer flex justify-center">
            <div className=" flex flex-wrap items-center xl:justify-between justify-center">
             <div className="Banner_Text">
                 ...
                 <div className="w-[700px] text-[72px] font-inter font-bold ">
                    <h2 className='text-[#fffffffb]'>Front-End <p className='text-[#cbacf9d5] inline-block'>React JS</p><h2 className='inline text-[#cf7238e7] mt-[-24px]'>Developer</h2></h2>
                </div>
                 <h3 className='text-[24px] font-inter font-normal tracking-[3px]'>Hi! I’m Joy, A React.JS Developer based in Bangladesh</h3>
                 <div className="mt-14 flex gap-5">
                    <Link to={"https://github.com/MahbubJoy-web"} target='blank' className='w-[230px] py-[22px] px-[40px] bg-gradient-to-r from-[#161A31] to-[#06091F] rounded-[14px] border-[3px] border-[#20243dda] text-sm font-inter font-medium flex items-center'>
                        <p className='text-[18px] font-inter font-medium'>See my work</p>
                        <span className='ml-2 text-[20px]'>
                            <GoArrowUpRight/>
                        </span>
                    </Link>
                    <Link to={CV} download={CV.pdf} target='blank' className='w-[240px] py-[22px] px-[40px] bg-gradient-to-r from-[#161A31] to-[#06091F] rounded-[14px] border-[3px] border-[#20243dda] text-sm font-inter font-medium flex items-center'>
